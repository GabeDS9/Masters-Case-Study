    ...
    public async Task RunEvaluationTest()
    {
        ...
        foreach (var campus in campusDTList)
        {
            ...
            foreach (var prec in precinctDTList)
            {
                ...
                foreach (var build in buildingDTList)
                {
        ...
        EvaluationTestModel testInfo = new EvaluationTestModel
        {
            ...
            RAMusageMBUnity = temp.RAMusageMBUnity,
            RAMusageMBDTs = temp.RAMusageMBDTs,
            RAMusageMBServices = temp.RAMusageMBServices,
            RAMusagePercUnity = temp.RAMusagePercUnity,
            RAMusagePercDTs = temp.RAMusagePercDTs,
            RAMusagePercServices = temp.RAMusagePercServices,
            RAMusageMBTotal = temp.RAMusageMBTotal,
            RAMusagePercTotal = temp.RAMusagePercTotal,
            CPUusageDTs = temp.CPUusageDTs,
            CPUusageServices = temp.CPUusageServices,
        ...
        //{
            EvaluationTestModel temp = await GetInformation("Energy", "Averages", "Collective", "HIV Bestuur Gebou", dtLevel, sDate, TempDate, "Day");
            EvaluationTestModel testInfo = new EvaluationTestModel
            {
                NumberOfDTs = 1,
                NumberOfCampuses = 0,
        ...
        dtLevel.Add("All");
        await Task.Delay(200);
        EvaluationTestModel temp1 = await GetInformation("Energy", "CurrentData", "Collective", "Stellenbosch University", dtLevel, "", "", "");
        EvaluationTestModel testInfo1 = new EvaluationTestModel
        {
            NumberOfDTs = numberOfDTs,
            NumberOfCampuses = numberOfCampuses,
            NumberOfPrecincts = numberOfPrecincts,
            NumberOfBuildings = numberOfBuildings,
            TotalTimeTaken = temp1.TotalTimeTaken,
            DTResponseTimeTaken = temp1.DTResponseTimeTaken,
            VisualTimeTaken = temp1.VisualTimeTaken,
            NumberOfDataPoints = temp1.NumberOfDataPoints,
            RAMusageMBUnity = temp1.RAMusageMBUnity,
            RAMusageMBDTs = temp1.RAMusageMBDTs,
            RAMusageMBServices = temp1.RAMusageMBServices,
            RAMusagePercUnity = temp1.RAMusagePercUnity,
            RAMusagePercDTs = temp1.RAMusagePercDTs,
            RAMusagePercServices = temp1.RAMusagePercServices,
            RAMusageMBTotal = temp1.RAMusageMBTotal,
            RAMusagePercTotal = temp1.RAMusagePercTotal,
            CPUusageDTs = temp1.CPUusageDTs,
            CPUusageServices = temp1.CPUusageServices,
            CPUusageUnity = temp1.CPUusageUnity,
            CPUusageTotal = temp1.CPUusageTotal
        };
        testInformation.Add(testInfo1);
        ...
        string sDate, string eDate, string timePer)
    {
        ...
        if (DateList != null)
        {
            testInfo = new EvaluationTestModel
            {
                ...
                DTResponseTimeTaken = dtResponse,
                VisualTimeTaken = visualTime,
                NumberOfDataPoints = DateList.Count,
                RAMusageMBUnity = memoryUsageMBUnity,
                RAMusageMBDTs = memoryUsageMBDTs,
                RAMusageMBServices = memoryUsageMBService,
                RAMusageMBTotal = ramTotalMB,
                RAMusagePercUnity = memoryUsagePercUnity,
                RAMusagePercDTs = memoryUsagePercDTs,
                RAMusagePercServices = memoryUsagePercService,
                RAMusagePercTotal = ramTotalPerc,
                CPUusageDTs = cpuUsageDTs,
                CPUusageServices = cpuUsageService,
                CPUusageUnity = cpuUsageUnity,
