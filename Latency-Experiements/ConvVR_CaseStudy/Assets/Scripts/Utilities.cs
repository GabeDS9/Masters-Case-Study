...
namespace Utils
{
    public class Utilities
    {
        ...
        public List<string> GenerateDateList(string startDate, string endDate, string type)
        {
            ...
            DateTime start = DateTime.ParseExact(ChangeDateFormat(startDate), "yyyy-MM-dd", System.Globalization.CultureInfo.InvariantCulture);
            DateTime end = DateTime.ParseExact(ChangeDateFormat(endDate), "yyyy-MM-dd", System.Globalization.CultureInfo.InvariantCulture);
